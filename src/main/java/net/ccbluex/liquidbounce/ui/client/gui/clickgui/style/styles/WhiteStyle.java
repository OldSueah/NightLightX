...
extends Style {
    ...
    public void drawPanel(int mouseX, int mouseY, Panel panel) {
        ...
        Fonts.font35.func_78276_b(LanguageManager.INSTANCE.get(panel.getName().replaceAll("%", "")), (int)((float)panel.getX() - (textWidth - 100.0f) / 2.0f), panel.getY() + 7 - 3, Color.BLACK.getRGB());
    }
    ...
    public void drawDescription(int mouseX, int mouseY, String text) {
        ...
        GlStateManager.func_179117_G();
        Fonts.font35.func_78276_b(LanguageManager.INSTANCE.get(text.replaceAll("%", "")), mouseX + 12, mouseY + Fonts.font35.field_78288_b / 2, Color.BLACK.getRGB());
    }
    ...
    public void drawModuleElement(int mouseX, int mouseY, ModuleElement moduleElement) {
        ...
        Gui.func_73734_a((int)(moduleElement.getX() - 1), (int)(moduleElement.getY() - 1), (int)(moduleElement.getX() + moduleElement.getWidth() + 1), (int)(moduleElement.getY() + moduleElement.getHeight() + 1), (int)this.hoverColor(new Color(217, 217, 217, moduleElement.slowlyFade), moduleElement.hoverTime).getRGB());
        GlStateManager.func_179117_G();
        Fonts.font35.func_78276_b(LanguageManager.INSTANCE.get(moduleElement.getDisplayName().replaceAll("%", "")), moduleElement.getX() + 5, moduleElement.getY() + 5, Color.BLACK.getRGB());
