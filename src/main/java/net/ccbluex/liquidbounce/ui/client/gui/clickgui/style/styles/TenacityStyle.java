...
extends Style {
    ...
    public void drawPanel(int mouseX, int mouseY, Panel panel) {
        if (panel.getFade() > 0) {
            ...
            RenderUtils.customRounded((float)panel.getX() + 2.0f, (float)panel.getY() + 17.0f + (float)panel.getFade(), (float)panel.getX() + (float)panel.getWidth() - 2.0f, (float)panel.getY() + 19.0f + (float)panel.getFade() + 5.0f, 0.0f, 0.0f, 7.0f, 7.0f, new Color(33, 33, 33).getRGB());
        } else {
        ...
        float textWidth = Fonts.fontTenacityBold35.func_78256_a("\u00a7f" + StringUtils.func_76338_a((String)LanguageManager.INSTANCE.get(panel.getName().replaceAll("%", ""))));
        Fonts.fontTenacityBold35.func_78276_b(LanguageManager.INSTANCE.get(panel.getName().replaceAll("%", "")), (int)((float)panel.getX() - (textWidth - 100.0f) / 2.0f), panel.getY() + 7 - 3, Color.WHITE.getRGB());
    }

    @Override
    public void drawDescription(int mouseX, int mouseY, String text) {
        int textWidth = Fonts.font35.func_78256_a(LanguageManager.INSTANCE.get(text.replaceAll("%", "")));
        RenderUtils.drawBorderedRect(mouseX + 9, mouseY, mouseX + textWidth + 14, mouseY + Fonts.font35.field_78288_b + 3, 3.0f, new Color(33, 33, 33).getRGB(), new Color(33, 33, 33).getRGB());
        GlStateManager.func_179117_G();
        Fonts.font35.func_78276_b(LanguageManager.INSTANCE.get(text.replaceAll("%", "")), mouseX + 12, mouseY + Fonts.font35.field_78288_b / 2, Color.WHITE.getRGB());
    }

    @Override
    public void drawButtonElement(int mouseX, int mouseY, ButtonElement buttonElement) {
        Gui.func_73734_a((int)(buttonElement.getX() - 1), (int)(buttonElement.getY() - 1), (int)(buttonElement.getX() + buttonElement.getWidth() + 1), (int)(buttonElement.getY() + buttonElement.getHeight() + 1), (int)this.hoverColor(buttonElement.getColor() != Integer.MAX_VALUE ? new Color(14, 159, 255) : new Color(217, 217, 217), buttonElement.hoverTime).getRGB());
        GlStateManager.func_179117_G();
    ...
    public void drawModuleElement(int mouseX, int mouseY, ModuleElement moduleElement) {
        if (moduleElement.getModule().getState()) {
            Gui.func_73734_a((int)(moduleElement.getX() + 2), (int)(moduleElement.getY() - 1), (int)(moduleElement.getX() + moduleElement.getWidth() - 2), (int)(moduleElement.getY() + moduleElement.getHeight()), (int)this.hoverColor(new Color(0, 0, 0, 30), moduleElement.hoverTime).getRGB());
        } else {
            Gui.func_73734_a((int)(moduleElement.getX() + 2), (int)(moduleElement.getY() - 2), (int)(moduleElement.getX() + moduleElement.getWidth() - 2), (int)(moduleElement.getY() + moduleElement.getHeight() + 1), (int)this.hoverColor(new Color(33, 33, 33), moduleElement.hoverTime).getRGB());
        }
        GlStateManager.func_179117_G();
        float modtextWidth = Fonts.fontTenacity35.func_78256_a(moduleElement.getDisplayName().replaceAll("%", ""));
        Fonts.fontTenacity35.drawString(LanguageManager.INSTANCE.get(moduleElement.getDisplayName().replaceAll("%", "")), (float)moduleElement.getX() - (modtextWidth - 100.0f) / 2.0f, moduleElement.getY() + 5, Color.WHITE.getRGB());
        ...
        if (!moduleValues.isEmpty() && moduleElement.isShowSettings()) {
            ...
            for (Value<?> value : moduleValues) {
                ...
                if (value instanceof BoolValue) {
                    ...
                    Fonts.font35.func_78276_b(text, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.slowlySettingsYPos + 2, (Boolean)((BoolValue)value).get() != false ? Color.WHITE.getRGB() : new Color(160, 160, 160).getRGB());
                ...
                if (value instanceof ListValue) {
                    ...
                    Fonts.font35.func_78276_b(text2, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.slowlySettingsYPos + 2, Color.WHITE.getRGB());
                    Fonts.font35.func_78276_b(listValue.openList ? "-" : "+", (int)((float)(moduleElement.getX() + moduleElement.getWidth()) + moduleElement.getSettingsWidth() - (float)(listValue.openList ? 5 : 6)), moduleElement.slowlySettingsYPos + 2, Color.WHITE.getRGB());
                    ...
                    for (String valueOfList : listValue.getValues()) {
                        ...
                        GlStateManager.func_179117_G();
                        Fonts.font35.func_78276_b("- " + valueOfList, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.slowlySettingsYPos + 2, listValue.get() != null && ((String)listValue.get()).equalsIgnoreCase(valueOfList) ? Color.WHITE.getRGB() : new Color(160, 160, 160).getRGB());
                        moduleElement.slowlySettingsYPos += Fonts.font35.field_78288_b + 1;
                    }
                    if (listValue.openList) continue;
                ...
                if (value instanceof FloatValue) {
                    ...
                    if ((valueOfSlide = TenacityStyle.drawSlider(((Float)floatValue.get()).floatValue(), floatValue.getMinimum(), floatValue.getMaximum(), moduleElement.getX() + moduleElement.getWidth() + 8, moduleElement.slowlySettingsYPos + 14, (int)moduleElement.getSettingsWidth() - 12, mouseX, mouseY, new Color(7, 152, 252))) != ((Float)floatValue.get()).floatValue()) {
                        floatValue.set(Float.valueOf(valueOfSlide));
                    }
                    Fonts.font35.func_78276_b(text3, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.slowlySettingsYPos + 3, Color.WHITE.getRGB());
                ...
                if (value instanceof IntegerValue) {
                    ...
                    if ((valueOfSlide = TenacityStyle.drawSlider(((Integer)integerValue.get()).intValue(), integerValue.getMinimum(), integerValue.getMaximum(), moduleElement.getX() + moduleElement.getWidth() + 8, moduleElement.slowlySettingsYPos + 14, (int)moduleElement.getSettingsWidth() - 12, mouseX, mouseY, new Color(7, 152, 252))) != (float)((Integer)integerValue.get()).intValue()) {
                        integerValue.set((int)valueOfSlide);
                    }
                    Fonts.font35.func_78276_b(text4, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.slowlySettingsYPos + 3, Color.WHITE.getRGB());
                    moduleElement.slowlySettingsYPos += 19;
                    continue;
                }
                ...
                GlStateManager.func_179117_G();
                Fonts.font35.func_78276_b(text, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.slowlySettingsYPos + 4, Color.WHITE.getRGB());
