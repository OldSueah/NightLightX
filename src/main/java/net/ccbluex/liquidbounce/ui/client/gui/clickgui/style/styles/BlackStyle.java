...
extends Style {
    ...
    public void drawPanel(int mouseX, int mouseY, Panel panel) {
        ...
        Fonts.font35.func_78276_b(LanguageManager.INSTANCE.get(panel.getName().replaceAll("%", "")), (int)((float)panel.getX() - (textWidth - 100.0f) / 2.0f), panel.getY() + 7 - 3, Color.WHITE.getRGB());
    }
    ...
    public void drawModuleElement(int mouseX, int mouseY, ModuleElement moduleElement) {
        ...
        GlStateManager.func_179117_G();
        Fonts.font35.func_78276_b(LanguageManager.INSTANCE.get(moduleElement.getDisplayName().replaceAll("%", "")), moduleElement.getX() + 5, moduleElement.getY() + 5, Color.WHITE.getRGB());
            ...
            if (moduleElement.isShowSettings()) {
                ...
                for (Value<?> value : moduleValues) {
                    ...
                    if (value instanceof ListValue) {
                        ...
                        if (mouseX >= moduleElement.getX() + moduleElement.getWidth() + 4 && (float)mouseX <= (float)(moduleElement.getX() + moduleElement.getWidth()) + moduleElement.getSettingsWidth() && mouseY >= moduleElement.slowlySettingsYPos && mouseY <= moduleElement.slowlySettingsYPos + Fonts.font35.getHeight() && Mouse.isButtonDown((int)0) && moduleElement.isntPressed()) {
