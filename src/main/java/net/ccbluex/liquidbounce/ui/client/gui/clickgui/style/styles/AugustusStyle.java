...
extends Style {
    ...
    public void drawPanel(int mouseX, int mouseY, Panel panel) {
        ...
        Fonts.font35.func_78276_b(panel.getName(), panel.getX() + 5, panel.getY() + 7, this.textColor.getRGB());
    }

    @Override
    public void drawDescription(int mouseX, int mouseY, String text) {
        int textWidth = Fonts.font35.func_78256_a(text);
        RenderUtils.drawBorderedRect(mouseX + 9, mouseY, mouseX + textWidth + 14, mouseY + Fonts.font35.field_78288_b + 3, 3.0f, this.backgroundColor.getRGB(), this.panelColor.getRGB());
        Fonts.font35.func_78276_b(text, mouseX + 12, mouseY + 2, this.textColor.getRGB());
    }
    ...
    public void drawButtonElement(int mouseX, int mouseY, ButtonElement buttonElement) {
        ...
        Fonts.font35.func_78276_b(buttonElement.getDisplayName(), buttonElement.getX() + 5, buttonElement.getY() + 5, this.textColor.getRGB());
    }
    ...
    public void drawModuleElement(int mouseX, int mouseY, ModuleElement moduleElement) {
        ...
        Fonts.font35.func_78276_b(moduleElement.getModule().getName(), moduleElement.getX() + 5, moduleElement.getY() + 5, moduleTextColor.getRGB());
    }
}
